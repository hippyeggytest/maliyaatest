/**
    * This file provides browser-friendly methods for generating PDF files
 * using the browser's print functionality instead of direct PDF generation.
 * 
 * This approach avoids encoding issues with Arabic text that are common
 * when using direct PDF generation libraries.
 */

/**
 * Generate a receipt that can be printed as PDF
...
/**
 * Generate a financial report that can be printed as PDF
 * @param {Object} data - Report data
 */
export const printFinancialReport = (data) => {
  // Open a new window for printing
  const printWindow = window.open('', '_blank');
